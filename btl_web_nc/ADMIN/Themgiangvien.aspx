<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/admin.Master" AutoEventWireup="true" CodeBehind="Themgiangvien.aspx.cs" Inherits="btl_web_nc.ADMIN.Themgiangvien" %>
        ...
        <div class="col-6">
         ...
         <div class="col-6">
             <div class="form-group">
                 ...
                 <asp:DropDownList ID="ddlBangcap" runat="server" OnSelectedIndexChanged="ddlBangcap_SelectedIndexChanged">
